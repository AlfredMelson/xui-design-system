  ...
  variants: {
    ...
    outline: {
      true: {
        ...
        WebkitTextStrokeColor: 'var(--alfredmelson-colors-typeface-primary)',
    ...
    variant: {
      ...
      primary: { color: 'var(--alfredmelson-colors-typeface-primary)' },
      secondary: { color: 'var(--alfredmelson-colors-typeface-secondary)' },
      tertiary: { color: 'var(--alfredmelson-colors-typeface-tertiary)' },
      info: { color: 'var(--alfredmelson-colors-brand)' },
      success: { color: 'var(--alfredmelson-colors-success)' },
      warning: { color: 'var(--alfredmelson-colors-warning)' },
      danger: { color: 'var(--alfredmelson-colors-danger)' },
    },
    weight: {
      1: {
