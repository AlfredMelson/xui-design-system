...
export const StyledButton = styled('button', {
  ...
  '--shadow-hover-primary':
    '0 2px 40px -4px var(--alfredmelson-form-input-focus)',
  ...
  variants: {
    variant: {
      primary: {
        '--background': 'var(--alfredmelson-colors-brand)',
        '--color': 'hsl(var(--palette-gray-00))',
        '&:disabled': {
          '--background': 'var(--alfredmelson-form-input-disabled)',
          '--color': 'var(--alfredmelson-colors-typeface-tertiary)',
        },
      ...
      secondary: {
        '--background': 'var(--alfredmelson-colors-emphasis)',
        '--color': 'var(--alfredmelson-colors-brand)',
        '&:disabled': {
          '--background': 'var(--alfredmelson-form-input-disabled)',
          '--color': 'var(--alfredmelson-colors-typeface-tertiary)',
        },
...
export const StyledIconButton = styled('button', {
  ...
  borderRadius: 'var(--border-radius-1)',
  color: 'var(--color, var(--alfredmelson-colors-typeface-tertiary))',
  ...
  '&::after': {
    ...
    background: 'var(--background, var(--alfredmelson-colors-foreground))',
  ...
  '&:hover': {
    '&:not(:disabled)': {
      '--border-color': 'var(--alfredmelson-colors-brand)',
